...
create_jobs = for i in 1..10 do
  Job.create!([title: "Job No.#{i}", description: " This is the No.#{i} public job been created", contact_email: "JobCreatedBySeedNumber#{i}@example.com",  wage_lower_bound: rand(10..49)*100, wage_upper_bound: rand(50..99)*100, is_hidden: false, company: "No.#{i} company!", category_id: rand(1..6), location_id: rand(1..5) ])
end
puts "10 Public jobs have been created. "


create_jobs = for i in 1..10 do
  Job.create!([title: "Job No.#{i}", description: " This is the No.#{i} hidden job been created ", contact_email: "JobCreatedBySeedNumber#{i}@example.com", wage_lower_bound: rand(10..49)*100, wage_upper_bound: rand(50..99)*100, is_hidden: true, company: "No.#{i} company!",category_id: rand(1..6), location_id: rand(1..5)])
end
